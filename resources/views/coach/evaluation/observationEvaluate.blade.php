...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeCourseTab = localStorage.getItem('activeCourseTab_observationEvaluateInd');
            var activePloTab = localStorage.getItem('activePloTab_observationEvaluateInd');
            if (activeCourseTab) {
        ...
        function switchCourseTab(courseCode) {
            ...
            localStorage.setItem('activeCourseTab_observationEvaluateInd', courseCode);
        ...
        function switchPloTab(courseCode, plo) {
            ...
            localStorage.setItem('activePloTab_observationEvaluateInd', plo);
        }
    </script>
@endsection
