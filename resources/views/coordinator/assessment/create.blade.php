            ...
            <form action="{{ route('coordinators.assessments.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="assessmentDescription" id="assessmentDescription" rows="4"
                        class="block w-full rounded-md p-2 border border-gray-300 focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 transition ease-in-out duration-150"></textarea>
                </div>
