...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="max-w-3xl mx-auto bg-gray-100 rounded-xl shadow-md overflow-hidden p-5">
            @if (session('success'))
            ...
            <div class="flex">
                <!-- Icon Section (Left) -->
                <div class="md:flex-shrink-0 flex justify-center items-center text-black text-5xl p-20">
                ...
                <div class="p-8 md:w-3/4">
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            @else
                                <div class="uppercase tracking-wide text-sm text-red-500 font-semibold">No Supervisor
                                    Assigned</div>
                            @endif
                        </div>
                        <div class="mt-4">
                            ...
                            @else
                                <div class="uppercase tracking-wide text-sm text-red-500 font-semibold">No Coach Assigned
                                </div>
                            @endif
                        </div>
                        <div class="mt-4">
