...
@section('content')
    <div class="container mx-auto p-4">
        <div class="m-5">
            <h1 class="text-center text-3xl font-bold">Head of Program Profile</h1>
        </div>
        <div class="max-w-md mx-auto bg-gray-100 rounded-xl shadow-md overflow-hidden p-5">
            ...
            <div class="flex">
                ...
                <div class="p-8 md:w-3/4">
                    ...
                    <h1 class="block mt-1 text-lg leading-tight font-medium text-black">{{ $hop->staffName }}</h1>
                    <div class="mt-4">
                        <div class="flex items-center">
                            <i class="fas fa-phone-alt text-gray-500"></i>
                            <p class="ml-2 text-black">{{ $hop->staffPhone }}</p>
                        </div>
                        <div class="flex items-center mt-2">
                            <i class="fas fa-envelope text-gray-500"></i>
                            <p class="ml-2 text-black">{{ $hop->staffEmail }}</p>
                        </div>
                        <div class="flex items-center mt-2">
                    ...
                    <div class="mt-8 justify-end">
                        <a href="{{ route('hop.profile.edit') }}" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">Update Profile</a>
                    </div>
                </div>
            </div>
        </div>
