...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="max-w-xl mx-auto bg-gray-100 rounded-xl shadow-md overflow-hidden p-5">
            ...
            <div class="flex">
                <!-- Icon Section (Left) -->
                <div class="md:flex-shrink-0 flex justify-center items-center text-black text-5xl p-11">
                ...
                <div class="p-8 md:w-3/4">
                    <div>
                        ...
                        <h1 class="block mt-1 text-lg leading-tight font-medium text-black">{{ $coordinator->staffName }}
                        </h1>
                        <div class="mt-4">
                        ...
                        <div class="mt-8 justify-end">
                            <a href="{{ route('coordinators.profile.edit') }}"
