...
@section('content')
                        ...
                        @foreach ($plosByCourse[$courseCode] as $index => $plo)
                            <div id="ploEvaluation{{ $courseCode }}{{ $plo }}"
                                ...
                                <div id="studentEvaluations{{ $courseCode }}{{ $plo }}">
                                    ...
                                    <form
                                        action="{{ route('supervisors.evaluations.documentEvaluate.store', $student->stuId) }}"
                                        method="POST">
                                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeCourseTab = localStorage.getItem('activeCourseTab_documentEvaluateUni');
            var activePloTab = localStorage.getItem('activePloTab_documentEvaluateUni');
            if (activeCourseTab) {
        ...
        function switchCourseTab(activeCourseTab) {
            ...
            localStorage.setItem('activeCourseTab_documentEvaluateUni', activeCourseTab);
        ...
        function switchPloTab(courseCode, activePloTab) {
            ...
            localStorage.setItem('activePloTab_documentEvaluateUni', activePloTab);
        }
