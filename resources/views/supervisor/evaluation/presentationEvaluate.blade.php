...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeCourseTab = localStorage.getItem('activeCourseTab_presentationEvaluateUni');
            var activePloTab = localStorage.getItem('activePloTab_presentationEvaluateUni');
            if (activeCourseTab) {
        ...
        function switchCourseTab(courseCode) {
            ...
            localStorage.setItem('activeCourseTab_presentationEvaluateUni', courseCode);
        ...
        function switchPloTab(courseCode, plo) {
            ...
            localStorage.setItem('activePloTab_presentationEvaluateUni', plo);
        }
    </script>
@endsection
