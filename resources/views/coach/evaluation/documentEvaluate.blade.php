...
@section('content')
                        ...
                        @foreach ($plosByCourse[$courseCode] as $index => $plo)
                            <div id="ploEvaluation{{ $courseCode }}{{ $plo }}"
                                ...
                                <div id="studentEvaluations{{ $courseCode }}{{ $plo }}">
                                    ...
                                    <form
                                        action="{{ route('coaches.evaluations.documentEvaluate.store', $student->stuId) }}"
                                        method="POST">
                                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeCourseTab = localStorage.getItem('activeCourseTab_documentEvaluateInd');
            var activePloTab = localStorage.getItem('activePloTab_documentEvaluateInd');
            if (activeCourseTab) {
        ...
        function switchCourseTab(activeCourseTab) {
            ...
            localStorage.setItem('activeCourseTab_documentEvaluateInd', activeCourseTab);
        ...
        function switchPloTab(courseCode, activePloTab) {
            ...
            localStorage.setItem('activePloTab_documentEvaluateInd', activePloTab);
        }
