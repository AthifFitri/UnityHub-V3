...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="p-4">
            ...
            @foreach ($courses as $course)
                <div id="evaluation{{ $course->courseId }}" class="p-5 bg-gray-100 rounded-b-md hidden printable">
                    ...
                    <div class="flex justify-between mb-4">
                        <div>
                            ...
                            <div class="flex flex-row">
                                ...
                                <p class="text-blue-500 font-medium text-base">{{ $student->supervisorDetails->staffName }}
                                </p>
                            </div>
                            <div class="flex flex-row">
                                <p class="font-semibold text-base text-gray-700 mr-2">Coach Name :</p>
                                <p class="text-blue-500 font-medium text-base">{{ $student->coachDetails->coachName }}</p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <button onclick="printReport()"
                                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md no-print">Print
                                Report</button>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end mt-4 no-print">
