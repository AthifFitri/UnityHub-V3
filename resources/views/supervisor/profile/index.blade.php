        ...
        <div class="max-w-md mx-auto bg-gray-100 rounded-xl shadow-md overflow-hidden p-5">
            ...
            <div class="flex">
                ...
                <div class="p-8 md:w-3/4">
                    ...
                    <h1 class="block mt-1 text-lg leading-tight font-medium text-black">{{ $supervisor->staffName }}</h1>
                    <div class="mt-4">
                    ...
                    <div class="mt-8 justify-end">
                        <a href="{{ route('supervisors.profile.edit') }}" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">Update Profile</a>
                    </div>
                </div>
            </div>
        </div>
