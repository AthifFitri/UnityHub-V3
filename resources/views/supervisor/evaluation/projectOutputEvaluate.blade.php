...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="p-4">
            <div class="flex flex-row mb-4">
                ...
                <form action="{{ route('supervisors.evaluations.projectOutputEvaluate') }}" method="GET">
                            ...
                            @foreach ($plosByCourse[$courseCode] as $index => $plo)
                                <div id="ploEvaluation{{ $courseCode }}{{ $plo }}"
                                    ...
                                    <div id="studentEvaluations{{ $courseCode }}{{ $plo }}">
                                        ...
                                        <form action="{{ route('supervisors.evaluations.projectOutputEvaluate.store') }}"
                                            method="POST">
                                            @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeCourseTab = localStorage.getItem('activeCourseTab_projectOutputEvaluateUni');
            var activePloTab = localStorage.getItem('activePloTab_projectOutputEvaluateUni');
            if (activeCourseTab) {
        ...
        function switchCourseTab(courseCode) {
            ...
            localStorage.setItem('activeCourseTab_projectOutputEvaluateUni', courseCode);
        ...
        function switchPloTab(courseCode, plo) {
            ...
            localStorage.setItem('activePloTab_projectOutputEvaluateUni', plo);
        }
    </script>
@endsection
