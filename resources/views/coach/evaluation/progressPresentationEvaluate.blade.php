...
@section('content')
                        ...
                        @else
                            <div id="studentEvaluations{{ $courseCode }}"
                                ...
                                @foreach ($plosByCourse[$courseCode] as $plo)
                                    <form action="{{ route('coaches.evaluations.progressPresentationEvaluate.store') }}"
                                        method="POST">
                                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeTab = localStorage.getItem('activeTab_progressPresentationEvaluate');
            if (activeTab) {
                switchTab(activeTab);
            }
        ...
        function switchTab(activeTab) {
            ...
            localStorage.setItem('activeTab_progressPresentationEvaluate', activeTab);
        }
