...
@section('content')
    <div class="container mx-auto p-4">
        <div class="m-5">
            <h1 class="text-center text-3xl font-bold">Supervisor University Profile</h1>
        </div>
        <div class="max-w-xl mx-auto bg-gray-100 rounded-xl shadow-md overflow-hidden p-5">
            ...
            <div class="flex">
                <!-- Icon Section (Left) -->
                <div class="md:flex-shrink-0 flex justify-center items-center text-black text-5xl p-12">
                ...
                <div class="p-8 md:w-3/4">
                    <div>
                        ...
                        <h1 class="block mt-1 text-lg leading-tight font-medium text-black">{{ $supervisor->staffName }}
                        </h1>
                        <div class="mt-4">
                            <div class="flex items-center">
                                <i class="fas fa-phone-alt text-gray-500"></i>
                                <p class="ml-2 text-black">{{ $supervisor->staffPhone }}</p>
                            </div>
                            <div class="flex items-center mt-2">
                                <i class="fas fa-envelope text-gray-500"></i>
                                <p class="ml-2 text-black">{{ $supervisor->staffEmail }}</p>
                            </div>
                            <div class="flex items-center mt-2">
                        ...
                        <div class="mt-8 justify-end">
                            <a href="{{ route('supervisors.profile.edit') }}"
