...
@section('content')
                            ...
                            @foreach ($plosByCourse[$courseCode] as $index => $plo)
                                <div id="ploEvaluation{{ $courseCode }}{{ $plo }}"
                                    ...
                                    <div id="studentEvaluations{{ $courseCode }}{{ $plo }}">
                                        ...
                                        <form
                                            action="{{ route('coaches.evaluations.finalPresentationEvaluate.store') }}"
                                            method="POST">
                                            @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var activeCourseTab = localStorage.getItem('activeCourseTab_finalPresentationEvaluateInd');
            var activePloTab = localStorage.getItem('activePloTab_finalPresentationEvaluateInd');
            if (activeCourseTab) {
        ...
        function switchCourseTab(courseCode) {
            ...
            localStorage.setItem('activeCourseTab_finalPresentationEvaluateInd', courseCode);
        ...
        function switchPloTab(courseCode, plo) {
            ...
            localStorage.setItem('activePloTab_finalPresentationEvaluateInd', plo);
        }
    </script>
@endsection
